...
std::string_view SimulationEventKindName(SimulationEventKind kind) {
  switch (kind) {
    ...
    case SimulationEventKind::kSimulationDurationReached:
      return "simulation_duration_reached";
    ...
    case SimulationEventKind::kCount:
      break;
  }
...
std::optional<SimulationEventKind> SimulationEventKindFromName(
  ...
  if (name == "wallet_workload_state")
    return SimulationEventKind::kWalletWorkloadState;
  if (name == "workload_state") return SimulationEventKind::kWorkloadState;
  ...
  if (name == "simulation_duration_reached")
    return SimulationEventKind::kSimulationDurationReached;
