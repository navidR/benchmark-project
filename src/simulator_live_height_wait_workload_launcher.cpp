...
LiveHeightWaitWorkloadLauncher MakeLiveHeightWaitWorkloadLauncher(
              ...
              try {
                ...
                while (true) {
                  ...
                  WriteEvent(
                      ...
                      HeightWaitDetail(record->ordinal, 0U, epoch_workload.node,
                                       epoch_workload.height, *observed_height,
                                       record->id));
                  lock.lock();
...
void JoinLiveHeightWaitWorkloadWorker(
